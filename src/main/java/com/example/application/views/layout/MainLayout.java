...
import com.example.application.views.admin.SalaryView;
import com.example.application.views.admin.VenteAdmin;
import com.example.application.views.admin.VueDeCompagne;
...
public class MainLayout extends AppLayout implements RouterLayout, BeforeEnterObserver {
    ...
    private void createSideBar() {
            ...
            addToDrawer(new VerticalLayout(
                    ...
                    new RouterLink("Vue de contact", VueDeCompagne.class ),
