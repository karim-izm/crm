...
public class UserForm extends FormLayout {
    ...
    TextField salary = new TextField("Salaire De Base");

    Checkbox isSup = new Checkbox("Superviseur");
    ...
    public UserForm() {
        ...
        isSup.addValueChangeListener(e -> {
    ...
    private Component configureFields() {
        VerticalLayout vl = new VerticalLayout(fullName, userName, email , salary , isSup,  password);
        return vl;
    }
