...
public class ListView extends VerticalLayout {
    ...
    private void deleteUser(UserForm.DeleteEvent event) {
        ConfirmDialog dialog = new ConfirmDialog("Confirm deletion", "Are you sure you want to delete this record?",
            ...
            updateList();
            closeEditor();
            Notification notification = new Notification("User Deleted Succefully");
    ...
    private void saveUser(UserForm.SaveEvent event) {
        ...
        updateList();
        closeEditor();
        Notification notification = new Notification("User Added Succefully");
    ...
    private Component configureGrid() {
        ...
        grid.setColumns("id", "fullName", "email", "username");
